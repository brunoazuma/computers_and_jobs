...
download_rais <- function(uf, year) {
  ...
  SELECT
    tb_rais.ano,
    tb_rais.sigla_uf,
    tb_rais.id_municipio,
    tb_rais.cnae_2,
    tb_rais.cnae_2_subclasse,
    tb_rais.subatividade_ibge,
    tb_rais.subsetor_ibge,
    tb_rais.quantidade_horas_contratadas,
    tb_rais.valor_remuneracao_media_sm,
    tb_rais.valor_remuneracao_media,
    tb_rais.cbo_2002,
    tb_rais.idade,
    tb_rais.grau_instrucao_1985_2005,
    tb_rais.grau_instrucao_apos_2005,
    tb_rais.sexo,
    tb_rais.raca_cor,
    tb_rais.indicador_portador_deficiencia,
    tb_rais.tamanho_estabelecimento,
  FROM
